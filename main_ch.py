...
def main(args):
    ...
    if args.mpspdz:
        ...
        if args.always_compile or not already_compiled:
            ...
            os.system('./compile.py -F 64 -X ' + args.filename_server + ' ' + str(args.port) + ' ' + str(num_params) + ' ' + str(num_gradients) + ' ' + str(args.niter) + ' ' + str(args.chunk_size) + ' ' + str(args.threads) + ' ' + str(args.parallels))
